...
# async def play_audio(room, source, text):
#     global is_speaking
...
# async def silence_monitor(room, source):
#     global last_user_audio

#     while True:
#         await asyncio.sleep(5)
#         if time.time() - last_user_audio > 20:
#             await play_audio(room, source, "Are you still there?")
#             last_user_audio = time.time()
...
#                         await play_audio(room, source, response)

#         asyncio.create_task(read_audio())

#     asyncio.create_task(silence_monitor(room, source))
